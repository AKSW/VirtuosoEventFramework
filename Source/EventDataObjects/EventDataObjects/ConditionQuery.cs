...
{
    public class ConditionQuery : IRemoteAction
    {
        ...
        public ConditionQuery(ref DataTable table, int rowIndex)
        {
        ...
        public ConditionQuery(string wsdlAddress, string endpointAddress, string methodeName, string description, List<string> paramTypes = null, List<string> paramDescription = null, string returnType = null,
